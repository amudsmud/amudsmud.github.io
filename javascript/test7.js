...
var shop = {
    ...
    velg_knapp : [],
    kjøp_knapp : [],
    biler : ["../bilder/spill/kjøretøy/biler/sedan1_default.png",
    "../bilder/spill/kjøretøy/biler/sedan1_blå.png",
    ...
    mange_produkter : function(numb) {
        ...
        for (i = 0; i < numb; i++){
            ...
            this.velg_knapp[i].innerHTML = "Kjøp";
            this.velg_knapp[i].style.display = "none";
    ...
    kjøp_func : function(m) {
        if (1000 > 500){
            if (typeof(localStorage.eier_bil) !== "undefined"){
                ...
                this.velg_knapp[m].innerHTML = "Velg";
...
function firekant(bredde, høyde, farge, x, y, type) {
    ...
    this.mstand = function(){
        if (this.fart > 0){
            this.mstand +=  this.fart/10
        }
        else {
            this.mstand -=  this.fart/10
        }
        /*if (typeof(Storage) !== "undefined" && !localStorage.mstand) {
            localStorage.setItem("mstand", Number(bil.mstand));
        }
        if (typeof(Storage) !== "undefined" && localStorage.mstand) {
            localStorage.mstand = Number(localStorage.mstand) + 123
            co*nsole.log(localStorage.mstand);
        }*/
    }
