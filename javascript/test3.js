...
function start_spill1() {
    ...
    bil = new firekant(50, 100, "grey", 1000, 900, "bil");
    fartometer = new firekant ("25px", "Arial", "black", 1880, 980, "text");
    gira = new firekant ("26px", "Arial", "black", 1780, 980, "text");
}
...
function firekant(bredde, høyde, farge, x, y, type) {
    ...
    this.kjøra = function(){
        if (this.gir == 2){
            this.maksfart = 8;
            if (platform.keys && platform.keys[17] && this.fart < 5) {this.gir -= 1;}/*control*/
            if (platform.keys && platform.keys[65] && this.fart / 8 < 0.4) {this.moveAngle = -1 * (this.fart / 4);}/*a*/
            if (platform.keys && platform.keys[65] && this.fart / 8 > 0.4) {this.moveAngle = -1 * (this.fart / 8);}/*a*/
            if (platform.keys && platform.keys[68] && this.fart / 8 < 0.4) {this.moveAngle = 1 * (this.fart / 4);}/*d*/
            if (platform.keys && platform.keys[68] && this.fart / 8 > 0.4) {this.moveAngle = 1 * (this.fart / 8);}/*d*/
            if (platform.keys && platform.keys[87] && this.fart < 3) {this.fart += 0.06;}/*w*/
            else if (platform.keys && platform.keys[87]) {this.fart += 0.15;}/*w*/
            if (platform.keys && platform.keys[83]) {this.fart -= 0.1;}/*s*/
            if (this.fart > 0) {this.fart -= 0.05} else {this.fart = 0;}
            if (this.fart > this.maksfart) {this.fart = this.maksfart;};
        }
        if (this.gir == 1){
            this.maksfart = 4;
            if (platform.keys && platform.keys[16] && this.fart > 3) {this.gir += 1;}/*shift*/
            if (platform.keys && platform.keys[17] && this.fart == 0) {this.gir -= 1;}/*control*/
            if (platform.keys && platform.keys[65] && this.fart / 8 < 0.4) {this.moveAngle = -1 * (this.fart / 4);}/*a*/
            if (platform.keys && platform.keys[65] && this.fart / 8 > 0.4) {this.moveAngle = -1 * (this.fart / 8);}/*a*/
            if (platform.keys && platform.keys[68] && this.fart / 8 < 0.4) {this.moveAngle = 1 * (this.fart / 4);}/*d*/
            if (platform.keys && platform.keys[68] && this.fart / 8 > 0.4) {this.moveAngle = 1 * (this.fart / 8);}/*d*/
            if (platform.keys && platform.keys[87]) {this.fart += 0.2;}/*w*/
            if (platform.keys && platform.keys[83]) {this.fart -= 0.1;}/*s*/
            if (this.fart > 0) {this.fart -= 0.05} else {this.fart = 0;}
            if (this.fart > this.maksfart) {this.fart = this.maksfart;};
        }
        if (this.gir == 0){
            this.maksfart = -4;
            if (platform.keys && platform.keys[16] && this.fart == 0) {this.gir += 1;}/*shift*/
            if (platform.keys && platform.keys[65] && this.fart / 8 < 0.4) {this.moveAngle = -1 * (this.fart / 4);}/*a*/
            if (platform.keys && platform.keys[65] && this.fart / 8 > 0.4) {this.moveAngle = -1 * (this.fart / 8);}/*a*/
            if (platform.keys && platform.keys[68] && this.fart / 8 < 0.4) {this.moveAngle = 1 * (this.fart / 4);}/*d*/
            if (platform.keys && platform.keys[68] && this.fart / 8 > 0.4) {this.moveAngle = 1 * (this.fart / 8);}/*d*/
